...
//  new tab, developer console, sources, snippets, paste ConvolverNode, click final line Number, then run, then look step by step with arrow to the right and dot icon.
