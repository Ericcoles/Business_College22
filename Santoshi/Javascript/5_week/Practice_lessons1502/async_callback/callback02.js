...
const calculateSum = (grades) => {
  sumGrades(grades, (anythingButRepresentsSumfromSumGrades) => {
    console.log(`The sum is: ${anythingButRepresentsSumfromSumGrades}`);
  });
};

// What is going on with grades, (anything)

// const calculateSum = (grades) => {
//   sumGrades(grades, (sumOfGradesFromSumGrades) => {
//     console.log(`The sum is ${sumOfGradesFromSumGrades}`);
//   });
// };
