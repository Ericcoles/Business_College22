...
// search.addEventListener ('keyup', ()=> {renderSearchResults(search);
// });

// //store "results-list" in one variable
// const results = document.querySelector("#results-list");
// // store "app-search" in another variable
// const search = document.querySelector("#app-search");

// // write function to renderSearchResults which takes some kind parameter
// // e.g. one parameter
// const renderSearchResults = (query = "") => {
//   // cleanuptheSearchquery ignoring leading and trailing spaces
//   // e.g. trim(), toLowewerCase()
//   const cleanuptheSearchquery = query.trim().toLowerCase();
//   // filter the data e.g. data.filter(//pass cleanuptheSearchquery)
//   const filteredData = data.filter((item) =>
//     item.spacecraft.toLowerCase().includes(cleanuptheSearchquery)
//   );
//   results.innerHTML = "";
//   // loop the filter data for each of those list items of spacecraft
//   filteredData.forEach((item) => {
...
//   });
// };
// // render the search with eventListener e.g. "keyup"
// search.addEventListener("keyup", () => {
