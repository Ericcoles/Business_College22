...
//  new tab, developer console, sources, snippets, paste ConvolverNode, save snippet with command s, click final line Number, then run with play button on bottom, then look step by step with arrow to the right and dot icon.
